$(function(){
    ...
    $list.on('click', function(){
        var $this = $(this);
        if($this.hasClass('list-active_item')) return;

        $list.removeClass('list-active_item');
        $this.addClass('list-active_item');

        $table.addClass('dn');

        var $selfTable = $table.eq($list.index($this));

        $selfTable.removeClass('dn');
    });
});
